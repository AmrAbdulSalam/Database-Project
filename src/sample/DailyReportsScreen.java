...
public class DailyReportsScreen  implements Initializable {
    ...
    @FXML
    private TableColumn < modelTable, Integer> licence_co;
    @FXML
    private TableColumn < modelTable, Integer> owner_co;
    @FXML
    private TableColumn < modelTable, String> start_co;
    @FXML
    private TableColumn < modelTable, String> end_co;
    @FXML
    ...
    public void personalInfo(MouseEvent mouseEvent) throws Exception {
  ...
  public void setTableView (ActionEvent e){
          ...
          while (rs.next()) {
              if (comboBox.getSelectionModel().getSelectedIndex() == 0) {
                  ...
                  if (entered_license == tablelicense) {
                      ...
                      list.add(new modelTable(s_d, e_d, l_n, c_i));
                      break;
                  }
                  ...
                  if (entered_startDate == rs.getString("start_date")) {
                      l_n = rs.getInt("license_no");
                      s_d = rs.getString("start_date");
                      e_d = rs.getString("end_date");
                      c_i = rs.getInt("CUSTOMER_ID");
...
//                  }
                  ...
                  if (entered_endDate == rs.getString("end_date")) {
                      l_n = rs.getInt("license_no");
                      s_d = rs.getString("start_date");
                      e_d = rs.getString("end_date");
                      c_i = rs.getInt("CUSTOMER_ID");
